...
UserName.PRIMARY.register('ose_un')
UserName.NON_PRIMARY.register('ose_nonp_un')
OperatorID.PRIMARY.register('ose_oid')
OperatorID.NON_PRIMARY.register('ose_nonp_oid')
SubUserId.VALID_PRIMARY.register('ose_suid')
