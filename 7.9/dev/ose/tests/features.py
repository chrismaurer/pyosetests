...
from ose.tests.overrides import OSE_OVERRIDES
...
#gatway.unsupported_accepts_hold.insert_combo(ProductType.FSPREAD, Tif.GTDATE)
...
def overrides(suite_type_mro, order_info, suffix):
    ...
    if 'OrderManagementSuite' in suite_type_mro_names:
        return OverrideSets([OSE_OVERRIDES, [spqc]])
    else:
